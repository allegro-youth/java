...
public class ClassRoomControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        classRooms.add(new ClassRoom(1, "Budynek g³ówny", 80));
        classRooms.add(new ClassRoom(2, "Budynek g³ówny", 70));
        classRooms.add(new ClassRoom(3, "Budynek g³ówny", 77));
        classRooms.add(new ClassRoom(4, "Budynek g³ówny", 15));
